...
<form class="row justify-content-center" method="post" action="reg.php">
   ...
   <?php include "app/helps/errorInfo.php";?>
    ...
    <div class="mb-3 col-12 col-md-4">
        <label for="formGroupExampleInput" class="form-label">Введіть ім'я користувача</label>
        <input name="login" value="<?=$login?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder">
      </div>
      <div class="w-100"></div>
    <div class="mb-3 col-12 col-md-4">
      <label for="exampleInputEmail1" class="form-label">Введіть вашу пошту</label>
    ...
    <div class="w-100"></div>
    <div class="mb-3 col-12 col-md-4">
        <label for="exampleInputPassword2" class="form-label">Повторіть ваш пароль</label>
