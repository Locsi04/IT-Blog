  ...
  <body>
    ...
    <?php include("../../app/include/sidebar-admin.php"); ?>
            ...
            <div class="posts col-9">
                ...
                <a href="create.php" class="col-2 btn btn-success">Додати категорію</a>
                <span class="col-1"></span>
                <a href="index.php" class="col-3 btn btn-warning">Керувати категоріями</a>
                </div>
                <div class="row title-table">

                    <h2>Управління категоріями</h2>
                    <div class="id col-1">ID</div>
                    <div class="id col-5">Назва</div>
                    <div class="red col-2">Керування</div>
                </div>
